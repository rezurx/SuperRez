...
export class TemplateEngine {
    ...
    async generateFromTemplate(templateName: string, customContext?: Record<string, any>): Promise<string | undefined> {
        try {
    ...
    private async buildTemplateContext(customVariables?: Record<string, any>): Promise<TemplateContext> {
    ...
    private async findCodeFiles(projectPath: string, extensions: string[]): Promise<string[]> {
        const files: string[] = [];
    ...
    private registerHandlebarsHelpers(): void {
        ...
        Handlebars.registerHelper('needsImport', function(framework: string, importName: string) {
